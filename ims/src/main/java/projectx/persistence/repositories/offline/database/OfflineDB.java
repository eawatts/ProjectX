...
public class OfflineDB {
	...
	private void populateData() {
		...
		products.add(new Product(14, "Another product", 150, 3.00, 20, "another very shiny product", suppliers, p1imgs));
		...
		products.add(new Product(20, "Another product", 150, 3.00, 20, "another very shiny product", suppliers, p1imgs));
		...
		products.add(new Product(26, "Another product", 150, 3.00, 20, "another very shiny product", suppliers, p1imgs));
